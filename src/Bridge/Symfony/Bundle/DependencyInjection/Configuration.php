                        ...
                        ->arrayNode('grpc')
                            ...
                            ->children()
                                ...
                                ->scalarNode('port')
                                    ...
                                    ->defaultValue(9503)
                                ->end()
                                ->scalarNode('default_package')
                                    ->defaultNull()
                                    ->info('Default package name for gRPC services (e.g., "myapp" will prefix services as /myapp.ServiceName)')
                                ->end()
                                ->booleanNode('interceptors')
                                    ->defaultFalse()
                                    ->info('Enable/disable gRPC interceptors (logging, caching, etc.)')
                                ->end()
                            ->end()
                        ->end()
                        ->arrayNode('static')
